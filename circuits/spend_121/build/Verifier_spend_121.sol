...
contract PlonkVerifier {
    ...
    uint16 constant nPublic   = 26;
    uint16 constant nLagrange = 26;
    
    uint256 constant Qmx  = 286545918632062241553157080376234596714652071745786243502512407239095328429;
    uint256 constant Qmy  = 6164624802758295882436548444143453206452389094095743484225764523861937381280;
    uint256 constant Qlx  = 21239610218217419093782493872967404372992325355234455735766616242171820686101;
    uint256 constant Qly  = 14399760769089099518931893956814362973845357695456853844070564488011170428422;
    uint256 constant Qrx  = 11902533597562082607691654523422780772717975666778245027371405786027523322151;
    uint256 constant Qry  = 6679668290059235389822695212610934919435390806471654675807399056402846833984;
    uint256 constant Qox  = 18567531929231573888374094893485655493354191962131468194117705417162399008332;
    uint256 constant Qoy  = 20220266593397169373177222020631621102445698639331284055102907366533679306631;
    uint256 constant Qcx  = 9531420359526449705093946818336991995659521784552711423728426182809375474285;
    uint256 constant Qcy  = 7522703546120527514805617719368684283159197749013587292634751709341359280676;
    uint256 constant S1x  = 14285681904304511263990543826437075461205383916244655321264191151519676726356;
    uint256 constant S1y  = 5041422585903755751008068882335308647897752620855482993621032356294611083115;
    uint256 constant S2x  = 17124678741852995602445027779592889687682574030910088910557390050367242436851;
    uint256 constant S2y  = 17271734320143606599359818125714741551199826016339219552031103900582790418006;
    uint256 constant S3x  = 8979359097484902099550695176115134039789183239417605239726281239410884279833;
    uint256 constant S3y  = 9360346114583489949251286485443678077342532615861349321464362600580976444018;
    ...
    uint16 constant lastMem = 1632;

    function verifyProof(uint256[24] calldata _proof, uint256[26] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 1344 ), calldataload(pA))
                mstore(add(mIn, 1376 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 1408 ), calldataload(pB))
                mstore(add(mIn, 1440 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1472 ), calldataload(pC))
                mstore(add(mIn, 1504 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1536), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 27 )
